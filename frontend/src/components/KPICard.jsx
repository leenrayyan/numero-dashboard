export default function KPICard({ title, value, subtitle, change, icon: Icon, accentColor = "#5B3A9E", gradient }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-4xl font-bold text-white tracking-tight relative">{value}</div>
